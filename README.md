...
2.  Go to `node_modules` ➜ `react-native-update-app-edoc2` and add `RNUpdateApp.xcodeproj`
...
```
include ':react-native-update-app-edoc2'
project(':react-native-update-app-edoc2').projectDir = new File(rootProject.projectDir, 	'../node_modules/react-native-update-app-edoc2/android')
```
...
dependencies {
    ...
    compile project(':react-native-update-app-edoc2')
}
```

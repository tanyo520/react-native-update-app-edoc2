...
public class RNUpdateAppModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        final String applicationName = this.reactContext.getApplicationInfo().loadLabel(this.reactContext.getPackageManager()).toString();
        try {
            ...
            constants.put(APP_NAME, applicationName);
